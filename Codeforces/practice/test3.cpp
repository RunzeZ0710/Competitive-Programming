...
bool case1(string x){
	...
	if(find(arr[1].begin(), arr[1].end(), x[0]) != arr[1].end()) return true;	
	if(find(arr[2].begin(), arr[2].end(), x[0]) != arr[2].end()) return true;
	if(find(arr[3].begin(), arr[3].end(), x[0]) != arr[3].end()) return true;
	return false;
}
...
int main(){
	...
	while(n--){
		...
		if(s.size() == 2) if(case2(s)) cout << "YES" << endl; else cout << "NO" << endl;
		if(s.size() == 3) if(case3(s)) cout << "YES" << endl; else cout << "NO" << endl;
		if(s.size() == 4) if(case4(s)) cout << "YES" << endl; else cout << "NO" << endl;
	}
}
